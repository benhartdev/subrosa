...
const ArtistForm = ({ artistId = null, existingData, onCancel, onSubmit, mode = "create", showWorkUpload = true  }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach((key) => {
      if (key === 'slug' && !formData[key]) return; // évite d’envoyer slug vide
    ...
    try {
      ...
      console.log("Contenu FormData", [...form.entries()]);
